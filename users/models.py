...
class User(AbstractUser):
    ...
    first_name = models.CharField('Имя', max_length=300, blank=True)
    last_name = models.CharField('Фамилия', max_length=300, blank=True)
...
class RegistrationEmail(models.Model):
    email = models.EmailField('email адрес', unique=True)
    confirmation_code = models.CharField('Код подтверждения', max_length=300)
